...
## Бюджеты
Глобально ≤ 92 задач/сутки (`globals.daily_task_cap`), по целям — в конфиге. Провалившаяся валидация получает 1 автоповтор: новая сессия Джулса стартует с той же ветки и чинит свой же фикс.
